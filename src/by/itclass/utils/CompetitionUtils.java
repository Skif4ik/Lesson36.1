...
import by.itclass.excepteptions.CompetitionException;
...
public class CompetitionUtils {
    ...
    public static void printResults(List<Cat> cats, List<Dog> dogs, Map<String, String> errors){
        ...
        System.out.println("Dog list size = " + dogs.size());
        printCollection(dogs);

        System.out.println("Error quantity = " + errors.size());
        printMap(errors);
    }
    ...
    public static void printResults(List<Cat> youngCats, List<Dog> youngDogs,
        ...
        System.out.println("Dog list size = " + oldgDogs.size());
        printCollection(oldgDogs);
